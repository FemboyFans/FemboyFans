...
class AddMinImageWidthAndHeightToConfig < ExtendedMigration[7.1]
  ...
  def down_image
    ...
    default_width = (Config.column_defaults["image_width"] || {}).dig("max") || DEFAULT_IMAGE_MAX
    max_height = Config.image_height["max"]
    default_height = (Config.column_defaults["image_height"] || {}).dig("max") || DEFAULT_IMAGE_MAX
  ...
  def down_mascot
    ...
    default_width = (Config.column_defaults["mascot_width"] || {}).dig("max") || DEFAULT_MASCOT_MAX
    max_height = Config.mascot_height["max"]
    default_height = (Config.column_defaults["mascot_height"] || {}).dig("max") || DEFAULT_MASCOT_MAX
