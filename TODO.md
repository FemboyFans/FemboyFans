...
| [config/config.rb](config/config.rb#L163) | 163 | appealed posts should be visible, but this makes it far too easy to get the contents of deleted posts at a moments notice |
