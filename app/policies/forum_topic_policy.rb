...
class ForumTopicPolicy < ApplicationPolicy
  ...
  def permitted_attributes
    ...
    attr += %i[is_sticky is_locked lock_reason] if user.is_moderator?
    attr
  end
  ...
  def permitted_search_params
    params = super + %i[title title_matches category_id is_sticky is_locked lock_reason is_hidden creator_id creator_name updater_id updater_name] + nested_search_params(creator: User, updater: User)
