...
module DynamicConfig
  ...
  category("Size Limits") do
    ...
    add_object_field(:image_width, Config.values_for_hash_column("image_width"))
    add_object_field(:image_height, Config.values_for_hash_column("image_height"))
    ...
    add_object_field(:mascot_width, Config.values_for_hash_column("mascot_width"))
    add_object_field(:mascot_height, Config.values_for_hash_column("mascot_height"))
