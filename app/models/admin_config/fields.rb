...
class AdminConfig
  module Fields
    ...
    category("Action Limits") do
      ...
      add_number_field(:audio_track_per_day_limit)
      add_number_field(:audio_track_per_post_limit)
    ...
    category("Other") do
      ...
      add_boolean_field(:enable_takedowns, hint: "Enable the takedown system.")
